      ...
      <div className="about__container container grid">
        <div className="about_title__container">
          <h2 className="about__header grid">
            <span id="title-first">Achieve</span>
            <span id="title-second">Significant</span>
            <span id="title-third">Change</span>
            <span id="title-forth">
        ...
        <div className="about__content">
          <p>
            ...
            future opportunities. Achieving lasting results in only a few weeks,
            not years, with some fears and phobias released in just a few hours.
            Unlike other forms of therapy, my approach will not require you to
            relive the past or even share the details of those events
          </p>
          <p>
          ...
          <p>
            ...
            practitioner of hypnotherapy. In addition, I am certified as a core
            transformation and wholeness coach.
          </p>
          <p>
            I work with my clients over a span of three months and sessions are
            conducted via video call or in person
          </p>
        </div>
      </div>
